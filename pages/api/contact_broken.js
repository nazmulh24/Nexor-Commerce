        ...
        <div class="content">
            <div class="info-section">
                <div class="info-row">
                    ...
                    <div class="info-value">${escapeHtml(sanitizedData.fullName)}</div>
                </div>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <a href="mailto:${escapeHtml(sanitizedData.email)}">${escapeHtml(sanitizedData.email)}</a>
                    </div>
                </div>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">${escapeHtml(sanitizedData.company || "Not specified")}</div>
                </div>
            ...
            <div class="message-section">
                ...
                <div class="message-content">${escapeHtml(sanitizedData.message)}</div>
            </div>
            
            <div class="action-section">
                <a href="mailto:${escapeHtml(sanitizedData.email)}?subject=Re: Your inquiry&body=Hello ${escapeHtml(sanitizedData.fullName)},%0D%0A%0D%0AThank you for contacting us." class="reply-button">
